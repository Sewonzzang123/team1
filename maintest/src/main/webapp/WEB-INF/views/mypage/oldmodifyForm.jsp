	...
	<main id="content" class="modifyForm">
		<form:form modelAttribute="info">
			...
			<table>
						...
						<ul>
							...
							<li class="myinfo_form">
								<div class="password-header">
									<label for="txtPassword" class="text__label"> 현재 비밀번호 </label>
								</div>
							...
							<li class="myinfo_form">
								...
								<div class="password-body">
									<input class="mypage_modify_btn" type="submit" id="PWChangeBtn"
										value="비밀번호 변경"
				...
				<tr class="table-head">
					<th>전화번호</th>
					<td class="table-data"><select id="tel1" name="tel1">
							<option value="010">010</option>
							<option value="070">070</option>
					</select>-<input id="tel2" name="tel2" class="txtTel" type="text">-<input
						id="tel3" name="tel3" class="txtTel" type="text"></td>
				</tr>
			</table>
			<br>
			<div class="mypage_modify_btns">
				<input class="mypage_modify_btn" type="submit" value="회원정보 수정" formaction="${pageContext.request.contextPath}/mypage/modify">
				<input class="mypage_modify_btn" type="button" value="회원정보 취소">
				<input class="mypage_modify_btn" type="button" value="회원탈퇴 신청">
			</div>
		</form:form>
	</main>