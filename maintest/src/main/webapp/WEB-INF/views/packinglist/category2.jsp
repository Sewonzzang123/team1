							...
							<li>
								<div>
									...
									<div name="iname" value="${listingVO.itemVO.i_name }"
										class="item${listingVO.itemVO.i_num }"
										selected="${listingVO.CHECKED  }">${listingVO.itemVO.i_name }</div>
									<input type="text" name="icount" value="${listingVO.ICOUNT }"
										max="100" />
									<div class="edit_number">
										<input type="button" class="plusBtn" onClick="plus(this)">증가</input><input
											type="button" class="minusBtn" onClick="minus(this)">감소</input>
									</div>
									<a href="#"><i class="fas fa-minus"
										onClick="deletelist_f(this)"> </i></a>
								</div>
								<input type="hidden" name="icategory"
