...
<link rel="stylesheet" 	href="${contextPath}/css/board/boardWriteModifyFrm.css?ver=${today}">
<link rel="stylesheet" 	href="${contextPath}/css/board/button.css?ver=2"> 
<script defer type="text/javascript"	src="${contextPath }/js/board/boardModifyFrm.js?ver=${today}"></script>
							...
							<form:form id="Frm" name="Frm" method="POST"
								...
								<ul>
									...
									<li> <input name="btitle"
										type="text" value="${boardVO.btitle }" placeholder="제목을 입력하세요."  /> 
										<form:errors
									...
									<li class="bcontent_li"><label for="bcontent"></label> <input
										...
										<div class="bcontent_area" contenteditable="true"  data-placeholder="내용을 입력하세요">${boardVO.tcontent }</div>
