...
public class TestController {
	...
	@PostMapping({ "/upload", "/upload/{files}" })
	public String test(MultipartHttpServletRequest request, HttpSession session, Model model) throws Exception {
...
//			File thum = null;
//			Thumbnails.of(multifiles.get(0).getName()).size(50, 50).outputFormat("png").toFile(thum);
...
//		boardFileVO.setFthumbnail(
//				File.separator + "resources" + ymdPath + File.separator + "s" + File.separator + "s_" + fileName);
...
//	썸네일 보기
	...
	public String getThumb(Model model) {
