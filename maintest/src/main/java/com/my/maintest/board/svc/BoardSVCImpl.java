...
//전체글 조회 (default)
	...
	// 전체글 조회 + 페이징
	@Override
	public List<BoardVO> selectArticles(String btype, int catnum, int reqPage, long recNumPerPage, String searchType,
			String searchKeyword) {
		PagingComponent pagingComponent = pagingSVC.getPagingComponent(btype, catnum, reqPage, recNumPerPage,
				searchType, searchKeyword);

		return boardDAO.selectArticles(catnum, pagingComponent.getRecordCriteria().getRecFrom(),
...
//게시판 타입 조회 
	...
	@Override
	public Map<String, Object> selectArticlesWithKey(String btype, long catnum, int reqPage, long recNumPerPage,
		...
		log.info("pagingComponent.getRecordCriteria().getRecFrom()     =   "
				+ pagingComponent.getRecordCriteria().getRecFrom());
		log.info("pagingComponent.getRecordCriteria().getRecTo()     =   "
				+ pagingComponent.getRecordCriteria().getRecTo());
		log.info("pagingComponent.getPageCriteria().getPagingNumFrom()    =   "
				+ pagingComponent.getPageCriteria().getPagingNumFrom());
		log.info("pagingComponent.getPageCriteria().getPagingNumTo()      =   "
				+ pagingComponent.getPageCriteria().getPagingNumTo());
		...
		if (btype.equals("album")) {
			...
			list = boardDAO.selectArticlesWithKey_Album(catnum, pagingComponent.getRecordCriteria().getRecFrom(),
			...
			list = boardDAO.selectArticlesWithKey_Blog(catnum, pagingComponent.getRecordCriteria().getRecFrom(),
					pagingComponent.getRecordCriteria().getRecTo(), searchType, searchKeyword);
		}
