...
public class ItemListController {
	...
	public String itemForm2(@PathVariable(value = "lnum", required = false) String lnum, ItemVO itemVO,
			ItemCategoryVO itemCategoryVO, Model model) {
	...
	public String inum(@RequestParam(value = "inum", required = false) List<String> inum,
			...
			@RequestParam(value = "checked", required = false) List<String> checked, Model model) {
	...
	// �꽭�뀡 �븘�씠�뵒 諛쏆븘�꽌 �쟾�떖留뚰빐二쇰㈃�맆�벏??
	@PostMapping("/loadListForm")
	public String uploadListForm(HttpSession session, Model model) {
